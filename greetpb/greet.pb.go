...
func (x *Greeting) GetFirst_Name() string {
	if x != nil {
		return x.First_Name
	}
	return ""
...
func (x *Greeting) GetLast_Name() string {
	if x != nil {
		return x.Last_Name
	}
	return ""
...
var file_greetpb_greet_proto_rawDesc = []byte{
	...
	0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x46, 0x69, 0x72, 0x73,
	0x74, 0x5f, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x46, 0x69,
